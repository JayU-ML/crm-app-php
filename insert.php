...
$sql = "INSERT INTO mirai_results_test(clientOfficialName,clientNickName,closingDay,makingInvoiceDay,sendingMoneyDay,gaiyou, indate)VALUES(:clientOfficialName, :clientNickName, :closingDay, :makingInvoiceDay, :sendingMoneyDay, :gaiyou, sysdate())";
