            ...
            <div class="row row-group m-0">
              <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">注文数<span class="float-right">+4.2%
              ...
              <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">収益<span class="float-right">+1.2% <i
              ...
              <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">訪問者数 <span class="float-right">+5.2% <i
                        class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
              </div>
              <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">メッセージ数 <span class="float-right">+2.2% <i
                        class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
              </div>
            </div>
